...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_foregroundText)){
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_foregroundText);
                if(foreground != null){
                    this.setForegroundDrawable(foreground);
                }else{
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_foregroundText, 0xff000000));
                }
            }

            if(a.hasValue(R.styleable.MagicTextView_backgroundText)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_backgroundText);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_backgroundText, 0xff000000));
                }
            }
