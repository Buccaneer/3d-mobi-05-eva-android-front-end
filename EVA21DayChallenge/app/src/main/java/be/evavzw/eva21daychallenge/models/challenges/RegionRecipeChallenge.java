 ...
 */
@DatabaseTable(tableName = "region_recipe_challenges")
public class RegionRecipeChallenge extends Challenge implements Serializable {
    ...
    RegionRecipeChallenge() //for ormlite
    {
    }

    public RegionRecipeChallenge(RecipeCategory category, Recipe recipe) {
        this.category = category;
        this.recipe = recipe;
    }

    public RegionRecipeChallenge(JSONObject jsonObject) throws Exception {
        super(jsonObject);
